...
void* OpenPhysicalWindow(char* name, char* type, char* source, int w, int h, char* fileloc) {
    ...
    webkit_settings_set_enable_developer_extras(settings, FALSE); // Disables the inspector/console!
    webkit_settings_set_enable_write_console_messages_to_stdout(settings, FALSE); // Stops logging to terminal
